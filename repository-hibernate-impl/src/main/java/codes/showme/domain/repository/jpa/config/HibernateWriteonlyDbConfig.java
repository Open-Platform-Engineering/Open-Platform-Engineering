...
@ConfigurationProperties("e_i_codeplanet.db.writeonly")
public class HibernateWriteonlyDbConfig implements InitializingBean {
    ...
    public Map<String, Object> exportProperties(){
        ...
        result.put("jakarta.persistence.query.timeout", 100);
        result.put("jakarta.persistence.lock.timeout", 100);
        result.put("packagesToScan",getPackagesSplitByComma().split(","));
        result.put("hibernate.archive.autodetection","class");
    ...
    public String toString() {
        return "HibernateWriteonlyDbConfig{" +
